...
针对事件监控场景，阿里开源了事件离线工具kube-eventer，我们可以通过它来收集容器事件来丰富Kuernetes在监控方面的维度和准确性，弥补其他监控方案的缺欠。

但在AIOPS和智能化运维场景下，对于每次发出的事件通知，我们无法快速知道其产生原理和原因，因些，在原来事件基础上做了一次通知改造，通过整合问题知识库，以类似AI方式展示事件告警。效果如下：
...
***优化： 通过整合内外部容知识库，实现智能告警。***
### 3.3、代码实现
略
## 四、大屏监控
![alt text](/yw/eventer/image-4.png)
[链接](https://prometheus.mddcloud.com.cn/d/kubernetes-event-exporter/kubernetes-events?orgId=1&refresh=1m)