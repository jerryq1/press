...
![img](../../public/test_group/2024/network_emulator/wps1.jpg) 

2、控制面板\所有控制面板项\网络和共享中心，设置WLAN（360免费WiFi-91）

![img](../../public/test_group/2024/network_emulator/wps2.jpg) 

3、wiffi对应的物理地址

![img](../../public/test_group/2024/network_emulator/wps3.jpg) 

 

![img](../../public/test_group/2024/network_emulator/wps4.jpg) 

4、属性-勾选NEWT NDIS6，否则network emulator上可能没有360wifi的网卡

![img](../../public/test_group/2024/network_emulator/wps5.jpg) 
...
![img](../../public/test_group/2024/network_emulator/wps6.jpg) 

b、再建一个过滤器Filter,Configuration->New Filter

![img](../../public/test_group/2024/network_emulator/wps7.jpg) 
...
![img](../../public/test_group/2024/network_emulator/wps9.png) 



![img](../../public/test_group/2024/network_emulator/wps10.png) 



![img](../../public/test_group/2024/network_emulator/wps11.png) 



![img](../../public/test_group/2024/network_emulator/wps12.png) 

---也可以直接设置rtt抖动值

![img](.../../public/test_group/2024/network_emulator/wps13.jpg) 

备注：Latency：网络延迟，即rtt抖动500~700ms 

 先使用手机搜索并连接到360wiffi：

![img](../../public/test_group/2024/network_emulator/wps14.jpg) 

设置好之后，先点击脚印，再点开始，之后在RT Traffic Monitor可以看是动态的变化

![img](../../public/test_group/2024/network_emulator/wps15.png) 



前提要有手机连上这个网络，连上之后选择loss rate我们就可以看到动态的丢包率了

![img](../../public/test_group/2024/network_emulator/wps16.png) 
...
![img](../../public/test_group/2024/network_emulator/wps17.png) 
